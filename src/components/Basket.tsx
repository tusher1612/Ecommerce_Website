...
import { getTotal, groupbyId } from "@/app/utils/busketActions"; // Import utility functions for calculating totals and grouping products
import { useCartStore } from "@/store/store"; // Import custom hook to access the cart store
