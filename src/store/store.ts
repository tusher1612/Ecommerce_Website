...
import { Product } from '@/types/types'  // Import Product type for type safety
import { CartState, WishlistState, User } from '@/types/types'  // Import custom types for Cart and Wishlist state
